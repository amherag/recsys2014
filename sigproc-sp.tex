...
intelligent tutoring system called Protoboard (http://www.protoboard.org/), which focuses on the
...
\begin{figure}
  \centering
  \epsfig{file=navigation-tree.eps, width=3.5in}
...
\begin{figure}
  \centering
  \epsfig{file=exercise.eps, width=3.5in}
